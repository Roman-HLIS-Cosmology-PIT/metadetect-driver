...
Scripts are provided for running metadetect on images (via direct paths), blocks (parsing IMCOM directories), and mosaics (parsing IMCOM directories), as well as for producing diagnostic reports and for postprocessing.
