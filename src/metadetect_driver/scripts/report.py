...
def _report_block(
    ...
    block_wcs_footprint = block_wcs.calc_footprint()
    ...
    covering_healpixels = hp.query_polygon(
        NSIDE,
        hp.ang2vec(block_wcs_footprint[:, 0], block_wcs_footprint[:, 1], lonlat=LONLAT),
        inclusive=True,
        nest=NEST,
